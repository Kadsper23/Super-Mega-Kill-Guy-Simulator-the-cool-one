...
namespace Mirror.SimpleWeb
{
    internal static class ReceiveLoop
    {
        ...
        public static void Loop(Config config)
        {
            ...
            {
<<<<<<<< Updated upstream:Assets/Mirror/Runtime/Transport/SimpleWebTransport/Common/ReceiveLoop.cs
                // log as info only
========
>>>>>>>> Stashed changes:Assets/Mirror/Runtime/Transports/SimpleWebTransport/Common/ReceiveLoop.cs
                Log.InfoException(e);
            }
