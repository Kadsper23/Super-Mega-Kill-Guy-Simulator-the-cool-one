...
<<<<<<<< Updated upstream:Assets/Mirror/Runtime/Transport/SimpleWebTransport/Server/SimpleWebServer.cs
========
        {
...
>>>>>>>> Stashed changes:Assets/Mirror/Runtime/Transports/SimpleWebTransport/Server/SimpleWebServer.cs
        {
            return server.CloseConnection(connectionId);
        }
