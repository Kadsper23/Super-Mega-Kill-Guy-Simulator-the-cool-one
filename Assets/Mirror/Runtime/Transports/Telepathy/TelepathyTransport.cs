...
<<<<<<<< Updated upstream:Assets/Mirror/Runtime/Transport/Telepathy/TelepathyTransport.cs
========
        ...
        private void CreateClient()
        {
            // create client
            client = new Telepathy.Client(clientMaxMessageSize);
>>>>>>>> Stashed changes:Assets/Mirror/Runtime/Transports/Telepathy/TelepathyTransport.cs
            // client hooks
